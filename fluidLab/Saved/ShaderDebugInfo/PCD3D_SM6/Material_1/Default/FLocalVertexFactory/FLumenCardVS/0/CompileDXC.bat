...
%DXC% /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality /T vs_6_6 /E Main /Fc LumenCardVertexShader.d3dasm /Fo LumenCardVertexShader.dxil LumenCardVertexShader.usf
:END
PAUSE
