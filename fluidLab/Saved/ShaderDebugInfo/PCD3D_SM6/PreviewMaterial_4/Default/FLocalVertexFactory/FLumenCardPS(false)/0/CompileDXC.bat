...
%DXC% /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality /T ps_6_6 /E Main /Fc LumenCardPixelShader.d3dasm /Fo LumenCardPixelShader.dxil LumenCardPixelShader.usf
:END
PAUSE
